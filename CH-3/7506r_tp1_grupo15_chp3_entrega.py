...
#MEJORES HIPERPARAMETRO : C=5 ->f1score: 0.807
...
# fitting the model for grid search
grid.fit(x_train_minmax, y_train)
#MEJORES HIPERPARAMETROS SON: C=5 y gamma= 0.01 ->f1score : 0.811
...
# fitting the model for grid search
grid.fit(x_train_minmax, y_train)
#MEJO : C=0.1 y gamma=5 f1score = 0.833
...
##g. Generar predicciones con el set de test
"""
